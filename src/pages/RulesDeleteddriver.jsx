...
function DriverRules() {
  ...
  const deleteRule = async () => {
    try {
      ...
      await api.delete(`/rules/permanent?id=${deleting}`);
      ...
      <div className="overflow-x-auto min-h-[80vh]">
        ...
        <Table>
          <Table.Head>
            ...
            <Table.HeadCell>Reinstate</Table.HeadCell>
            <Table.HeadCell></Table.HeadCell>
            <Table.HeadCell></Table.HeadCell>
            <Table.HeadCell></Table.HeadCell>
            <Table.HeadCell></Table.HeadCell>
            <Table.HeadCell>Permanent Delete</Table.HeadCell>
          </Table.Head>
